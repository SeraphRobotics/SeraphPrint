...
**
** Created: Mon Dec 12 15:23:19 2011
...
static const uint qt_meta_data_QextSerialPort[] = {
 ...
 // enum data: key, value
     389, uint(QextSerialPort::Polling),
     397, uint(QextSerialPort::EventDriven),
...
static const char qt_meta_stringdata_QextSerialPort[] = {
    ...
    "baudRate\0setCustomBaudRate(int)\0set\0"
    "setDtr(bool)\0setDtr()\0setRts(bool)\0"
...
int QextSerialPort::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 9: setCustomBaudRate((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 10: setDtr((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 11: setDtr(); break;
        case 12: setRts((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 13: setRts(); break;
        case 14: d_func()->_q_onWinEvent((*reinterpret_cast< HANDLE(*)>(_a[1]))); break;
        case 15: d_func()->_q_canRead(); break;
        default: ;
        }
        _id -= 16;
    }
